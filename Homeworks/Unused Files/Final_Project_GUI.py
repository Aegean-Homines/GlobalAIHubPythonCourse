...
class Question():
    def __init__(self, question, answers, correctAnswersIndex):
...
def main():
    ...
    for entry in response["results"]:
        ...
        potentialAnswers.insert(correctIndex, correctAnswer)
        
        question = Question(question, potentialAnswers, correctIndex)
